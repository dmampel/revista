    ...
    return(
        ...
        <div>
            <div className="relative bg-contain bg-no-repeat bg-center lg:mt-24">
                ...
                <img className='absolute max-w-[30%] md:max-w-[25%] top-36 left-[9em] md:top-10 md:left-[17em] lg:left-[19em] lg:-top-[10em] xl:left-[30em] xl:-top-[10em] 2xl:-top-10 2xl:left-[30rem]' src={cover} alt="" />
